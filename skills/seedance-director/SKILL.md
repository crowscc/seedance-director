...
**台词密度规则**：约 3 字/秒。3s 镜头 ≤ 9 字，5s 镜头 ≤ 15 字，10s 镜头 ≤ 30 字。超出标注 ⚠。
```
...
| 信息密度 | ✓/✗ | 每个镜头是否有实质内容，无空镜浪费 |
| 冲突/反转/价值点 | ✓/✗ | 在第X秒出现 / 无（建议补充） |
| 台词密度 | ✓/✗ | 全程X字/秒，超出镜头：[列举镜号或"无"] |
| 结尾行动号召 | ✓/✗ | [CTA类型：悬念留白/引导评论/产品信息/情感升华] |
| 平台调性 | ✓/✗ | 是否符合[目标平台]内容风格 |
