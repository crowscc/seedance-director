...
- 旁白：[完整旁白脚本，按镜头标注，如"镜头1旁白：'这条街，藏着整个城市最深的烟火气。' 镜头3旁白：'三块钱一碗的豆腐脑，喝了二十年。'"] 音色参考：[音色和语气，如"年轻女声，语气轻松自然"]
...
- **旁白/配音全部由即梦生成**，不走后期配音。旁白必须写出完整文案（实际要说的话），不能只写"描述产品特点"等概括性指令。台词写在镜头描述里（角色A："台词"），旁白写在声音设计里（完整脚本+音色参考）
